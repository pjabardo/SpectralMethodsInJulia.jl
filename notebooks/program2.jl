...
# ╔═╡ 5ac8643b-38f5-4f11-b9ce-31f76c0cd2ba
begin 
	using CairoMakie
...
# ╔═╡ d8c066dc-4f30-11ed-352c-67babe624d11
md"""
# Program 2: convergence of periodic spectral method

Implementation of program 2 in chapter 1


"""

# ╔═╡ 5f76ac08-75b8-42a1-ba52-f997b7c559ea
N = 2:2:100

# ╔═╡ 8594e85f-0487-4012-925c-eecabbf0688a
...
# ╔═╡ f3848459-6065-41eb-8d32-875ac6e02210
err = calc_error.(N)

# ╔═╡ 87176194-e2a1-46de-aae7-b0d42178f26f
scatter(N, err, axis=(yscale=log10,xscale=log10, xlabel="N",
							ylabel="Error", title="Spectral method"))
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "8876ccbf17b916bac568ec3fcecbe418755a8a2e"
